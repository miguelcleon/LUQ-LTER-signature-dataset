...
met_nadp_daily_new_headers <- read_excel("2023-24h.xlsx",
                                sheet="2024 Daily Data", col_names = TRUE)
met_nadp_daily_new <- read_excel("2023-24h.xlsx",
                                sheet="2024 Daily Data", skip=2)
...
met_nadp_daily_new <- met_nadp_daily_new %>% rename("DATE" = "TIMESTAMP", "YEAR" = "YEAR", "JULIAN" = "JULIAN",
                                                    ...
                                                    "Downloads"="Downloads", "Comments" = "Sensor notes")
...
summary(met_nadp_daily_new)
write.csv(met_nadp_daily_new, "EVFSTowerMetDaily_2023_formatted.csv", row.names = FALSE)